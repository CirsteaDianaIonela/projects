...
SECRET_KEY = 'django-insecure-5!-d$$r#_e&zek_i&*m25a4@s%q^qucg=pft1c9a1wq)&y%d#4'
...
DATABASES = {
     ...
     'default': {
        ...
        'NAME':os.environ.get('DATABASE_NAME_DEFAULT', 'comparison'),

        'ENGINE': 'django.db.backends.mysql',

        'USER': os.environ.get('DATABASE_NAME_DEFAULT_USER', 'root'),
